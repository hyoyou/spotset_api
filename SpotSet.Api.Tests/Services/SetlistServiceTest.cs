...
namespace SpotSet.Api.Tests.Services
{
    public class SetlistServiceTest
    {
        ...
        public async void GetSetlistReturnsASetlistModelWhenCalledWithSetlistId()
        {
            ...
            var successSetlistService = MockSetup.CreateSuccessSetlistServiceWithMocks(newSetlist);
        ...
        {
            var errorSetlistService = MockSetup.CreateErrorSetlistServiceWithMocks();
